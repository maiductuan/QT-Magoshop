        ...
        <div class="tile">
            <div class="tile-body">
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                    ...
                    <tbody>
                    @foreach($listUsers as $listPro) 
                        <tr>
                            <td width="10"><input type="checkbox" name="check1" value="1"></td>
                            <td>{{$listPro->id}}</td>
                            <td>{{$listPro->user_name}}</td>
                            <td><span class="badge bg-success">{{$listPro->user_phone}}</span></td>
                            <td><span class="badge bg-success">+ {{number_format($listPro->user_mony)}} ₫</span></td>
                            <td>{{$listPro->user_adress}}</td>
                            <td>{{$listPro->user_email}}</td>
                            <td>{{$listPro->user_birthdate}}</td>
                            <td><a class="btn btn-primary btn-sm " style="color:red;" href="{{url('user-delete',$listPro->id)}} title="Xóa"
                            onclick="return confirm('Bạn có chắc chắn xóa không ?')"><i class="fas fa-trash-alt"></i> 
                                </a>
