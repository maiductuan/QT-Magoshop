          ...
          <div class="tile-body">
            ...
            <div class="row element-button">
              <div class="col-sm-2">
                ...
                <a class="btn btn-add btn-sm" href="{{url('nhan-vien/tao-nhan-vien')}}" title="Thêm"><i class="fas fa-plus"></i>
                  Tạo mới nhân viên</a>
              </div>
              <div class="col-sm-2">
            ...
            <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
              ...
              <tbody>
                @foreach($listNhanvien as $listNV)
                <tr>
                  <td width="10"><input type="checkbox" name="check1" value="1"></td>
                  <td>{{$listNV->id}}</td>
                  <td>{{$listNV->nv_name}}</td>
                  @if($listNV->nv_image == "")
                    <td><img class="img-card-person" src="../image/no_image_available.jpeg"></td>
                  @else
                    <td><img class="img-card-person" src="../upload/images/{{$listNV->nv_image}}"></td>
                  @endif
                  <td>{{$listNV->nv_adress}}</td>
                  <td>{{date("d/m/Y", strtotime($listNV->nv_birthdate))}}</td>
                  <td>{{$listNV->nv_sex}}</td>
                  <td>{{$listNV->nv_phone}}</td>
                  <td>{{$listNV->nv_cmnd}}</td>
                  <td>{{$listNV->role_id}}</td>
                  <td>{{number_format($listNV->nv_salary)}} VNĐ</td>
